...
public  class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback,
        ...
        CallCabCarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (requestType) {
                    ...
                    CallCabCarButton.setText("Call An Ambulance");
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists() && requestType) {
                            ...
                            CallCabCarButton.setText("Ambulance Found");
    ...
    {
        Intent startPageIntent = new Intent(CustomerMapActivity.this, MainActivity.class);
